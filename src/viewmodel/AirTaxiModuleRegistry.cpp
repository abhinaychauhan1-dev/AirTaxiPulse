...
AirTaxiModuleRegistry::AirTaxiModuleRegistry(QObject *parent)
    : QObject(parent)
    , m_flightSimulation(this)
    , m_primaryFlight(QStringLiteral("Primary Flight & Navigation Data"), m_flightSimulation, this)
    , m_propulsion(
    ...
    , m_safety(
          ...
          this)
{
        connect(&m_flightSimulation, &FlightSimulationService::telemetryChanged,
                        &m_primaryFlight, &PrimaryFlightViewModel::telemetryChanged);
}
